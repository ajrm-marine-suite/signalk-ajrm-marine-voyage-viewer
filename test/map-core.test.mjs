...
test("map page uses the standard left-side controls with zoom first", async () => {
  ...
  assert.match(html, /type="module" src="\.\/app\.js\?v=0\.6\.20"/);
  ...
  assert.match(await readFile(new URL("../public/ajrm-map-core.css", import.meta.url), "utf8"), /\[data-ajrm-map-help\]::after\{/);
